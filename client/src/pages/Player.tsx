...
const Player = () => {
  ...
  React.useEffect(() => {
    // Give more time for content to load, then check if we have valid data
    const timeoutId = setTimeout(() => {
      ...
      // Only redirect if we have no content, no IDs, no video URL, and we're not loading
      if (!hasValidContent && !hasValidIds && !hasVideoUrl && !isStillLoading) {
        ...
        console.log('Safety check passed - valid content found or still loading');
      }
    }, 10000); // Wait 10 seconds for content to load (increased from 3 seconds)
      ...
      <div className="pt-20">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="space-y-8">
            ...
            <div className="w-full advertisement-section" data-auto-click-ad>
