...
const SeeMore = () => {
  ...
  // Redirect to home if no content is provided
  React.useEffect(() => {
    ...
    <div className="min-h-screen">
      ...
      <div className="pt-20">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-6 md:gap-8 place-items-center">
            {paginatedContents.map((content: any, index: number) => {
              try {
                ...
                return (
                  <div key={`${transformedContent.id}-${index}`} className="w-full max-w-[280px] flex justify-center">
